...
local hotkeys_popup = require("awful.hotkeys_popup")
                      ...
                      beautiful.init("task_preview.lua")
...
kbdcfg.add_primary_layout("Canadien Francais", "CA", "ca")
kbdcfg.bind()
-- {{{ Mouse bindings
...
globalkeys = mytable.join(
 --awful.key({ altkey},"Tab" , function() os.execute('/.config/rofi/bin/launcher_misc') end,
    ...
    -- Screen brightness
awful.key({altkey}, "Up", function () brightness_widget:inc(10) end, {description = "increase brightness", group = "custom"}),
awful.key({altkey}, "Down", function () brightness_widget:dec(10) end, {description = "decrease brightness", group = "custom"}),
