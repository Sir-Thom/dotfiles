...
local trashbin_textbox = wibox.widget {
   ...
   local desktop = create_img_widget(icons.svg.desktop, desktop)
   local download = create_img_widget(icons.svg.folder, download)
   local trashbin = create_img_widget(icons.svg.trashbin, trashbin)
